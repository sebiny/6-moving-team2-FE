...
export default function Notification({ onToggle, isOpen }: Notification) {
  ...
  return (
    <div className="relative z-50 flex">
      ...
      {/* 알림 레이어 */}
      {isOpen && (
        <div className="border-line-200 absolute top-8 z-99 flex h-78 w-78 -translate-x-48 flex-col rounded-3xl border bg-gray-50 p-4 shadow-gray-300 md:top-10 xl:-translate-x-1/10">
