...
export default function RejectEstimateModal({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="reject-estimate-modal-title"
      aria-describedby="reject-estimate-modal-description"
    >
      <div
        className={clsx(
      ...
      >
        <div className="flex flex-col gap-[26px] lg:gap-10">
          <div className="flex justify-between">
            <h2
              id="reject-estimate-modal-title"
          ...
          {/* ModalContent 내용 시작 */}
          <div id="reject-estimate-modal-description" className="flex flex-col gap-7 self-stretch lg:gap-8">
            <div>
            ...
            <div className="m-0 flex flex-col gap-7 p-0 lg:gap-8">
              <div>
                ...
                />
                <div id="reject-reason-description" className="sr-only">
                  견적 거절 사유를 입력해주세요
                </div>
              </div>
            </div>
