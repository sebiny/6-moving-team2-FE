...
export default function EstimateHeaderSection({ moveType, isDesignated, status, customerName, price }: Props) {
  ...
  return (
    <div className="flex flex-col items-start gap-5 md:gap-7">
      ...
      {/* 견적가 */}
      <div className="flex w-full items-start text-base">
        {/* label - 고정 너비 */}
        <span className="w-28 font-semibold text-neutral-800 md:w-32 md:text-xl">{t("cost")}</span>

        {/* value - 오른쪽 정렬 */}
        <span className="flex-1 text-right text-xl font-bold text-neutral-800 md:text-2xl">
